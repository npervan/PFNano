...
def update_jets_AK4(process):
    ...
    from RecoBTag.ONNXRuntime.pfParticleNetAK4_cff import _pfParticleNetAK4JetTagsAll as pfParticleNetJetTagsAll
...
def add_BTV(process, runOnMC=False, onlyAK4=False, onlyAK8=False, keepInputs=['DeepCSV','DDX']):
    ...
    CommonVars = cms.PSet(
        ...
        btagDeepL=Var("bDiscriminator('pfDeepCSVJetTags:probudsg')",
                      ...
                      precision=10),
        btagPNet_probb=Var("bDiscriminator('pfParticleNetAK4JetTags:probb')",
                           float,
                           doc="ParticleNet b tag discriminator",
                           precision=10),
        btagPNet_probbb=Var("bDiscriminator('pfParticleNetAK4JetTags:probbb')",
                           float,
                           doc="ParticleNet bb tag discriminator",
                           precision=10),
        btagPNet_probc=Var("bDiscriminator('pfParticleNetAK4JetTags:probc')",
                           float,
                           doc="ParticleNet c tag discriminator",
                           precision=10),
        btagPNet_probcc=Var("bDiscriminator('pfParticleNetAK4JetTags:probcc')",
                           float,
                           doc="ParticleNet cc tag discriminator",
                           precision=10),
        btagPNet_probuds=Var("bDiscriminator('pfParticleNetAK4JetTags:probuds')",
                           float,
                           doc="ParticleNet uds tag discriminator",
                           precision=10),
        btagPNet_probg=Var("bDiscriminator('pfParticleNetAK4JetTags:probg')",
                           float,
                           doc="ParticleNet g tag discriminator",
                           precision=10),
        btagPNet_probundef=Var("bDiscriminator('pfParticleNetAK4JetTags:probundef')",
                           float,
                           doc="ParticleNet undef tag discriminator",
                           precision=10),
        btagPNet_probpu=Var("bDiscriminator('pfParticleNetAK4JetTags:probpu')",
                           float,
                           doc="ParticleNet pu tag discriminator",
                           precision=10),
        btagPNetDisc_BvsAll=Var("bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:BvsAll')",
                                float,
                                doc="ParticleNetDiscriminator B vs All",
                                precision=10),
        btagPNetDisc_CvsL=Var("bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:CvsL')",
                                float,
                                doc="ParticleNetDiscriminator C vs L",
                                precision=10),
        btagPNetDisc_CvsB=Var("bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:CvsB')",
                                float,
                                doc="ParticleNetDiscriminator C vs B",
                                precision=10),
        btagPNetDisc_QvsG=Var("bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:QvsG')",
                                float,
                                doc="ParticleNetDiscriminator Q vs G",
                                precision=10),
    )
